# To have control of images(outputs) that are produced by the GANs
# instead of log D(x) use log D(x|y) i.e probability of x when y has happened (inserting label information)
